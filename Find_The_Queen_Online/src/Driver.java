...
public class Driver
{
    ...
    public static class ServerThread extends Thread
    {
        ...
        String savedUserName1 = "dannyboi";
        String savedUserName2 = "matty7";

        String savedUser1PW = "dre@margh_shelled";
        String savedUser2PW = "win&win99";
        ...
        public void run()
        {
            try
            {
                ...
                {
                    System.out.println("com.company.Player Connected!\n");
                    gameState1 = 1;
